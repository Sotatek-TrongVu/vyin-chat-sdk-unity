...
namespace Gamania.GIMChat.Internal.Domain.TokenRefresh
{
    /// <summary>
    ...
    public class TokenRefreshManager
    {
        ...
        /// </summary>
        public bool IsTokenRefreshTrigger(GimException error)
        {
            if (error == null) return false;

            return error.ErrorCode == GimErrorCode.ErrInvalidSessionKeyValue ||
                   error.ErrorCode == GimErrorCode.ErrInvalidSession;
        }
        ...
        /// </summary>
        public void FailRefresh(GimException error)
        {
            if (!_isRefreshing)
            {
                return;
        ...
        private void OnTokenProvided(string token)
        {
            ...
            if (string.IsNullOrEmpty(token))
            {
                ...
                var error = new GimException(
                    GimErrorCode.SessionKeyRefreshFailed,
