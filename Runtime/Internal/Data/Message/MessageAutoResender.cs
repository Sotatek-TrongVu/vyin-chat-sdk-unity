...
namespace Gamania.GIMChat.Internal.Data.Message
{
    /// <summary>
    ...
    internal class MessageAutoResender : IMessageAutoResender
    {
        ...
        public void CleanupExpired()
        {
            ...
            foreach (var msg in expiredMessages)
            {
                ...
                msg.MarkAsFailed(GimErrorCode.PendingError);
                try
                {
                    msg.OnFailed?.Invoke(msg, new GimException(GimErrorCode.PendingError, "Message expired (TTL exceeded)"));
                }
                catch (Exception ex)
                {
