namespace Gamania.GIMChat
{
    ...
    /// </summary>
    public class GimBackgroundDisconnectionConfig
    {
        /// <summary>
        ...
        /// </summary>
        public static GimBackgroundDisconnectionConfig Default => new GimBackgroundDisconnectionConfig();

        /// <summary>
        /// Keep connection alive in background
        /// </summary>
        public static GimBackgroundDisconnectionConfig KeepAliveInBackground => new GimBackgroundDisconnectionConfig
        {
        ...
        /// </summary>
        public static GimBackgroundDisconnectionConfig IgnoreLifecycle => new GimBackgroundDisconnectionConfig
        {
        ...
        /// </summary>
        public static GimBackgroundDisconnectionConfig WithBackgroundDelay(float delaySeconds) => new GimBackgroundDisconnectionConfig
        {
            IsTrackingApplicationState = true,
